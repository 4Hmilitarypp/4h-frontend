...
const Partners: React.FC<RouteComponentProps> = () => {
  const [partners, setPartners] = React.useState<IPartnerSection[] | undefined>(
    undefined,
  );
  ...
  return (
    <Wrapper>
      <Hero>
        ...
        <Text>
          4-H Military Partners create opportunities and provide support to
          military connected youth whether they live on or near an installation,
          in our communities, or on overseas installations.
        </Text>
      ...
      <PartnerList>
        ...
        {partners ? (
          partners.map((partner, index) => (
            <PartnerSection partner={partner} key={partner._id} index={index} />
          ))
        ) : (
          <h2>Loading...</h2>
        )}
