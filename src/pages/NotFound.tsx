...
import { Button, Heading, Link, PageWrapper, Section } from '../components/Elements'
  ...
  return (
    <PageWrapper>
      <Section>
        ...
        <CustomP>
          After the website upgrade the urls to our resources changed. Most of the old information is on this new
        ...
        <CustomP>If you think this a page that should exist, please report feedback</CustomP>
        <CustomButton
          onClick={() =>
            Sentry.showReportDialog({
              eventId,
              labelComments: 'Which resource were you looking for?',
              subtitle2: "If you'd like to help, tell use which resource you think should be at this route",
