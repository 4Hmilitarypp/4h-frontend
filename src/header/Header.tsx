      ...
      <HeaderContainer>
        ...
        <Links ref={navRef as any} className={hamburgerActive ? 'mobile' : ''}>
          ...
          <LinkGroup title="Events" to="/events" manageBackground={backgroundManagement}>
            ...
            <StyledDropdownLink to="/events/calendars">
              <LinkTitle>Calendars</LinkTitle>
              <LinkDescription>Keep track of important dates and upcoming events near you</LinkDescription>
            </StyledDropdownLink>
          </LinkGroup>
