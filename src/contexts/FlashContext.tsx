...
export const useFlash = () => {
  ...
  const mySetFlashState = ({ message, isError = false }: ISetFlashStateArgs) =>
    setFlashState({ message, isError });
  const resetFlashState = React.useCallback(
    () => setFlashState(initialState),
    [initialState],
  );
