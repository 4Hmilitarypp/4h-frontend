...
it('should display all webinars initially', () => {
  ...
  // flushEffects()
  const differentWebinars = [
    staticWebinars[0].title,
    staticWebinars[3].title,
    staticWebinars[5].title,
  ];
  differentWebinars.forEach(webinar =>
    expect(getByText(webinar)).toBeDefined(),
  );
});
